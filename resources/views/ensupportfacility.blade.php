...
<body>
                    ...
                    <ul class="navbar-nav ms-auto ">
                        <li class="nav-item dropdown  mx-3">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="/award&sertification-en">Award & Sertification</a>
                                </li>
                        ...
                        <li class="nav-item mx-3">
                            <a class="nav-link text-light fw-lighter" href="/news-en">News</a>
                        </li>
                        <li class="nav-item mx-3">
                            <a class="nav-link text-light fw-lighter" href="site-en">Sitemap</a>
                        </li>
    ...
    <div class="container text-center">
        <div class="row d-flex justify-content-center ">
            <div class="col-lg-2 col-md-6 col-3 mt-5 Submenu fw-lighter"><a class="text-black-50"
                    style="text-decoration:none" href="/simplifieddiagram-en">Simplified Diagram</a></div>
            <div class="col-lg-2 col-md-6 col-5 mt-5 Submenu fw-lighter"><a class="text-black-50"
                    style="text-decoration:none" href="/rawmaterial-en">Raw Material</a></div>
            <div class="col-lg-2 col-md-6 col-5 mt-5 Submenu fw-lighter"><a class="text-black-50"
                    style="text-decoration:none" href="/process-en">Smelter</a></div>
            <div class="col-lg-2 col-md-6 col-5 mt-5 Submenu fw-lighter"><a class="text-black-50"
                    style="text-decoration:none" href="/refinery-en">Refinery</a></div>
            <div class="col-lg-2 col-md-6 col-5 mt-5 Submenu fw-lighter"><a class="text-black-50"
                    style="text-decoration:none" href="/acidplant-en">Acid Plant & WWTP</a></div>
            <div class="col-lg-2 col-md-6 col-5 mt-5 Submenu fw-bolder"><a class="text-black"
                    style="text-decoration:none" href="/supportfacility-en">Support Facility</a></div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 mt-3">
            ...
            <div class="col">
                <h4 class="heading fw-bold foregreen">1. Jetty and Wharf<span class="fw-lighter"></span></h4>
                <p class="mb-5">Two kilometers jetty and 230 meters wharf are designed to handle 35,000 tons vessels with normal unloading capacity of 350 tons/hour. The jetty & wharf conveyor can be used for both concentrate unloading and Cl-slag loading by the reversible belt conveyor.</p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 mt-3">
            ...
            <div class="col">
                <h4 class="heading fw-bold foregreen">2. Maintenance Workshop<span class="fw-lighter"></span></h4>
                <p class="mb-5">A two-kilometer dock and a 230-meter wharf are designed to handle ships with a
                    capacity of 35,000 tons and a normal unloading capacity of 350 tons/hour. Dock & wharf conveyors can
                    be used for unloading concentrate and Cl-slag via reversible belt conveyors.</p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 mt-3">
            ...
            <div class="col">
                <h4 class="heading fw-bold foregreen">3. Utility Consumption<span="fw-lighter"></span></h4>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 mt-3">
            ...
            <div class="col">
                <h4 class="heading fw-bold foregreen">4. Laboratory<span="fw-lighter"></span></h4>
                <p class="mb-5">The laboratory is responsible for analyzing samples for raw material and product
                    quality inspection, process control, and environmental monitoring. To fulfill this responsibility,
                    our laboratory is supported by competent personnel and equipped with modern analytical instruments,
                    such as ICP-OES, GF-AAS, XRF Spectrometer, UV-Visible Spectrophotometer, and Oxygen/Sulfur Analyzer.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 mt-3">
            ...
            <div class="col">
                <h4 class="heading fw-bold foregreen">5. Information Technology<span="fw-lighter"></span></h4>
                <p class="mb-5">PT Smelting uses an Enterprise Resource Planning (ERP) software system as the
                    primary business system to manage its core business activities such as Accounting & Finance, and
                    Procurement & Warehouse. As a companion to the ERP system, PT Smelting also uses a specific system
                    (PTS System) to manage the raw material business flow (copper concentrate) from unloading processes
                    to the main product (copper cathode). The 24-hour process monitoring of all plants is supported by a
                    Distributed Control System (DCS) connected to the PTS System.</p>
            </div>
        </div>
    </div>
