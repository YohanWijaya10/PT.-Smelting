...
<body>
    ...
    <div class="container">
        <div class="row mt-5">
            <a class="backbtn" href="/aboutus-en" style="text-decoration: none">
                <h5>← Back</h5>
            </a>
        </div>
    </div>
    ...
    <nav class="nav  justify-content-center">
        <a class="nav-link p-1 mx-md-5 text-black-50" aria-current="page" href="/overview-en">Overview</a>
        <a class="nav-link p-1 mx-md-5 text-black-50" href="/timeline-en">Timeline</a>
        <a class="nav-link p-1 mx-md-5 text-black active fw-bolder" href="/visionmission-en">Vision & Mission</a>
        <a class="nav-link p-1 mx-md-5 text-black-50" href="/gallery-en">Gallery</a>
    </nav>
    ...
    <div class="container mt-3 ">
        <div class="row imgKpmg justify-content-center align-items-center text-center">
            <div class="col reveal">
                <img src="img/kpmg.png" alt="">
