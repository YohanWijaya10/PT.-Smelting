...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5">
            <div class="col-md-7  mt-3 imageprocess">
...
<div class="container">
    <div class="row justify-content-center mb-5 mt-3">
        ...
        <div class="col">
            <h4 class="heading fw-bold foregreen">1. Gas Cleaning Section<span class="fw-lighter"></span></h4>
            <p class="mb-5">Copper concentrate is received through a ship at the dock, which can accommodate vessels with a capacity of up to 35,000 tons. A 2 km long dock is constructed to achieve sufficient water depth. A jetty is built at the end of the dock. Unloader with a clamshell bucket, covering a capacity of 350 t/h, ship loader for slag, and a reversible conveyor belt are installed. The unloaded concentrate is delivered to concentrate.</p>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row justify-content-center mb-5 mt-3">
        ...
        <div class="col">
            <h4 class="heading fw-bold foregreen">2. Drying Tower and Main Gas Blower<span class="fw-lighter"></span></h4>
            <p class="mb-5">Copper concentrate is received through a ship at the dock, which can accommodate vessels with a capacity of up to 35,000 tons. A 2 km long dock is constructed to achieve sufficient water depth. A jetty is built at the end of the dock. Unloader with a clamshell bucket, covering a capacity of 350 t/h, ship loader for slag, and a reversible conveyor belt are installed. The unloaded concentrate is delivered to concentrate.</p>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row justify-content-center mb-5 mt-3">
        ...
        <div class="col">
            <h4 class="heading fw-bold foregreen">3. Converter<span class="fw-lighter"></span></h4>
            <p class="mb-5">Dried SO2 gas is converted to SO3 by four beds of Vanadium pentoxide (V2O5) catalysts with an overall SO2 conversion rate exceeding 99.8%.</p>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row justify-content-center mb-5 mt-3">
        ...
        <div class="col">
            <h4 class="heading fw-bold foregreen">4. Absorption Tower<span class="fw-lighter"></span></h4>
            <p class="mb-5">SO3 gas exiting the third catalyst bed is absorbed into sulfuric acid in the Intermediate Absorption Tower (IAT). SO3 gas exiting the last catalyst bed is absorbed into sulfuric acid in the Final Absorption Tower (FAT) to produce sulfuric acid.</p>
        </div>
    </div>
</div>
    ...
    <div class="container fore">
        <div class="row  mt-5 ">
            <h3 class="heading fw-bold foregreen">Waste Water Treatment Plant<span class="fw-lighter"></span></h3>
        </div>
    </div>
    <div class="container">
        <div class="row justify-content-center mb-5">
            <div class="col-md-7  mt-3 imageprocess">
                <img src="/img/wwt.png" alt="">
            </div>
