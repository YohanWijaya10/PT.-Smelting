    ...
    <div class="container">
        <div class="container m-3 mt-5">
            <div class="row m-md-5">
                <h2 class="fw-bolder profileTitle ">News<span class="fw-light"> From Smelting : Siaran Pers</span>
                </h2>
            </div>
        </div>
        <div class="container text-center">
            <div class="row d-flex justify-content-center ">
                <div class="col-lg-2 col-md-6 col-3 mt-0 Submenu fw-lighter"><a class="text-black-50"
                        style="text-decoration:none" href="/news">Publikasi</a></div>
                <div class="col-lg-2 col-md-6 col-5 mt-0 Submenu fw-bolder"><a class="text-black"
