...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto ">
                    ...
                    <li class="nav-item dropdown  mx-3">
                        <a class="nav-link dropdown-toggle text-white fw-bolder" href="/csr-en" id="navbarDropdown"
                            role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            CSR Activity
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
    ...
    <div class="Countainer1" id="section1">
    ...
    <div class="container">
        <div class="row mt-5 ">
            <a class="backbtn" href="/csr-en" style="text-decoration: none">
    ...
    <div class="container mt-3">
        <div class="row ">
            <div class="col-md-10">
                <h2 class="fw-bold foregreen">Environment</h2>
                <p class="">
                </p>
            </div>
        </div>
    ...
    <div class="container mt-1">
        <div class="row   mb-2">
            ...
            <div class="col-md-7 mt-3">
                <h4 class="fw-bold foregreen">PT. Smelting: Mangrove and Javan Hawk-Eagle Conservation in Gresik</h4>
                <p class="">
                    PT. Smelting contributes to improve the quality of life environment surrounding area and Gresik Regency, through a mangrove conservation program at the orifice of the Leweyan river, Pangkah Kulon village, Ujung Pangkah subdistrict, Gresik. PT. Smelting is also committed to preserving the Javan Hawk-Eagle, in collaboration with Taman Safari I, Cisarua, Bogor.
                </p>
            </div>
        </div>
    </div>
