...
<body>
    ...
    <div class="container mt-3">
        <div class="row ">
            <div class="col-md-10">
                <h2 class="fw-bold foregreen">Education</h2>
                <p class="">
                </p>
            </div>
        </div>
    ...
    <div class="container mt-1">
        <div class="row   mb-2">
            ...
            <div class="col-md-7 mt-3">
                <h4 class="fw-bold foregreen">Empowering Communities: PT Smelting's Education Initiatives</h4>
                <p class="">
                    PT Smelting consistently supports the community, especially in the surrounding areas, to enhance their education quality through education incentive programs for teachers and underprivileged students, contributions to educational facilities, student scholarship programs, and the development of village libraries to stimulate community interest in reading.
                </p>
            </div>
        </div>
    </div>
