...
<body>
    ...
    <div class="container mt-3">
        <div class="row ">
            <div class="col-md-10">
                <h2 class="fw-bold foregreen">Social Economy</h2>
                <p class="">
                </p>
            </div>
        </div>
    ...
    <div class="container mt-1">
        <div class="row   mb-2">
            ...
            <div class="col-md-7 mt-3">
                <h4 class="fw-bold foregreen">Fostering Entrepreneurship: PT. Smelting's Community Empowerment Initiatives</h4>
                <p class="">
                    To create the spirit of entrepreneurship among communities surrounding the company, PT. Smelting provides entrepreneurship course programs and the establishment of small business units as well as assistance until the creation of business independency.
