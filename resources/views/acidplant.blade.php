    ...
    <div class="container text-center">
        <div class="row d-flex justify-content-center ">
            <div class="col-lg-2 col-md-6 col-3 mt-5 Submenu fw-lighter"><a class="text-black-50"
                    style="text-decoration:none" href="/simplifieddiagram">Simplified Diagram</a></div>
            <div class="col-lg-2 col-md-6 col-5 mt-5 Submenu fw-lighter"><a class="text-black-50"
                    style="text-decoration:none" href="/rawmaterial">Raw Material</a></div>
            <div class="col-lg-2 col-md-6 col-5 mt-5 Submenu fw-lighter"><a class="text-black-50"
                    style="text-decoration:none" href="/process">Smelter</a></div>
            <div class="col-lg-2 col-md-6 col-5 mt-5 Submenu fw-lighter"><a class="text-black-50"
                    style="text-decoration:none" href="/refinery">Refinery</a></div>
            <div class="col-lg-2 col-md-6 col-5 mt-5 Submenu fw-bolder"><a class="text-black"
                    style="text-decoration:none" href="/acidplant">Acid Plant & WWTP</a></div>
            <div class="col-lg-2 col-md-6 col-5 mt-5 Submenu fw-lighter"><a class="text-black-50"
                    style="text-decoration:none" href="/supportfacility">Support Facility</a></div>
