...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto ">
                    ...
                    <li class="nav-item mx-3">
                        <a class="nav-link text-light fw-ligter" href="/sitemap-en">Sitemap</a>
                    </li>
    ...
    <nav class="nav  justify-content-center ">
        <a class="nav-link p-1 mx-md-5 text-black-50" href="/overview-en">Overview</a>
        <a class="nav-link p-1 mx-md-5 text-black-50" href="/timeline-en">Timeline</a>
        <a class="nav-link p-1 mx-md-5 text-black-50" href="/visionmission-en">Vision & Mission</a>
        <a class="nav-link p-1 mx-md-5 text-black active fw-bolder" href="/gallery-en">Gallery</a>
    </nav>
