                ...
                <div class="col-12 col-lg-6 d-flex flex-column justify-content-between ">
                    ...
                    <div class="d-flex justify-content-end reveal">
                        <button class="btn btn-success btnProfile"> <a class="text-white"
                                style="text-decoration:none" href="aboutus-en">Read More</a></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-4 reveal" onclick="pindahKeBerita2()">
            <div class="row">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Historical Milestone of PT Smelting</h5>
                        <p class="card-text">The scorching sun did not deter President Joko Widodo (Jokowi) and several
                            ministers from admiring the copper smelter PT Smelting (PTS) in Gresik.</p>
        ...
        <div class="col-12 col-lg-6">
            ...
            <div class="row d-flex p-2 reveal childnews" onclick="pindahKeBerita1()">
                <div class="d-flex flex-row">
                    <div class="d-flex flex-column justify-content-center align-items-center ms-2 p-2 text-center date rounded">
                        <span class="fw-bolder">17</span>
                        <span class="fw-bold">Nov</span>
                    </div>
                    <div class="d-flex flex-column ms-2">
                        <span class="fw-bold">PT Smelting Achieves Green PROPER Again</span>
                        <span class="text-black-50">PT Smelting (PTS) once again achieves Green PROPER in 2023...</span>
                    </div>
                </div>
            </div>
            <div class="row p-2 reveal childnews" onclick="pindahKeBerita2()">
                <div class="d-flex flex-row">
                    ...
                    <div class="d-flex flex-column ms-2">
                        <span class="fw-bold">Historical Milestone of PT Smelting</span>
                        <span class="text-black-50">The scorching sun did not deter President Joko Widodo...</span>
                    </div>
                </div>
            </div>
            <div class="row p-2 reveal childnews" onclick="pindahKeBerita3()">
                <div class="d-flex flex-row">
                    ...
                    <div class="d-flex flex-column ms-2">
                        <span class="fw-bold">New Club for Runners</span>
                        <span class="text-black-50">Another hobby club is formed within the PT Smelting (PTS) community...</span>
                    </div>
                </div>
            </div>
