...
<body>
                ...
                <ul class="navbar-nav ms-auto ">
                    ...
                    <li class="nav-item dropdown  mx-3 text-light">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="/rawmateria-en">rawmaterial</a></li>
                            ...
                            <li><a class="dropdown-item" href="/supportfacilit-en">Support Facility</a></li>

                        </ul>
                    </li>
                    <li class="nav-item mx-3">
                        <a class="nav-link text-light fw-bold" href="/product-en">Product</a>
                    </li>
                    <li class="nav-item mx-3">
    ...
    <div class="container mt-4 fore">
        <div class="row fw-bolder ">
            <h3 class="heading foregreen fw-bold ">Main Product<span class="fw-lighter"></span></h3>
        </div>
    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex justify-content-end ">
                            <button class="btn btn-success btnproduct mt-2"> <a class=""
                                    style="text-decoration:none" href="/product1-en">Read More </a></button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container mt-2 fore">
        <div class="row fw-bolder ">
            <h3 class="heading foregreen fw-bold ">By Product<span class="fw-lighter"></span></h3>
        </div>
    </div>
    <div class="container mt-3">
        <div class="row">
            <div class="col-md-6 mt-md-4">
                <div class="row justify-content-start mb-5 d-flex">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex justify-content-end">
                            <button class="btn btn-success btnproduct mt-2"> <a class=""
                                    style="text-decoration:none" href="product2-en">Read More </a></button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 mt-md-4 ">
                <div class="row justify-content-start mb-5 d-flex">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex justify-content-end">
                            <button class="btn btn-success btnproduct mt-2"> <a class=""
                                    style="text-decoration:none" href="product3-en">Read More </a></button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 mt-md-4">
                <div class="row justify-content-start mb-5 d-flex">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex justify-content-end">
                            <button class="btn btn-success btnproduct mt-2"> <a class=""
                                    style="text-decoration:none" href="product4-en">Read More </a></button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 mt-md-4">
                <div class="row justify-content-start mb-5 d-flex">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex justify-content-end">
                            <button class="btn btn-success btnproduct mt-2"> <a class=""
                                    style="text-decoration:none" href="product5-en">Read More </a></button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 mt-md-4">
                <div class="row justify-content-start mb-5 d-flex">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex justify-content-end">
                            <button class="btn btn-success btnproduct mt-2"> <a class=""
                                    style="text-decoration:none" href="product6-en">Read More </a></button>
                        </div>
                    </div>
                </div>
            </div>
